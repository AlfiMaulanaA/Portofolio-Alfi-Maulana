...
class DatabaseService {
  ...
  private initializeTables() {
    // Create Users table with face_api_id
    this.db.exec(`
      CREATE TABLE IF NOT EXISTS users (
        ...
        face_api_id INTEGER DEFAULT NULL,
  ...
  private convertUserFromDb(user: any): User {
    return {
      ...
      face_api_id: user.face_api_id, // Keep as number or null
    };
  }
  ...
  public getUserStats() {
    try {
      ...
      return {
        ...
        faceApiSynced: faceApiSynced.count,
      };
    } catch (error) {
